                    ...
                    <div style={{ background: "rgba(153, 153, 153, 0.1)", height: 'calc(99vh - 55px)', padding: '10px 20px 0px' }}>
                        <div className="flex gap-2 pb-2">
                            <div style={{ display: 'flex', flexWrap: 'wrap', width: '800px', gap: '7px', alignItems: "center" }}>
                                ...
                                <span style={{ color: 'rgba(4, 76, 157, 1)', display: 'flex', fontWeight: 700, fontSize: '17px', minWidth: "220px" }}>  Item Wise Doctor Wise Report
                                </span>
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    {DoctorItemWiseColumns.map((column) => (
                                                        <th key={column.id} style={{ minWidth: column.minWidth }}>
                                                            {column.id === 'amount' ? (
                                                                <span className="sky_text">Rs. {total}</span>
                                                            ) : column.id === 'net_profit' ? (
                                                                <span className="sky_text" >Rs. {totalNetProfit}</span>
                                                            ) : column.id === 'qty' ? (
                                                                <span className="sky_text" >{qTY}</span>
                                                            ) : (
                                                                ''
                                                            )}
                                                        </th>
