                    ...
                    <div style={{ background: "rgba(153, 153, 153, 0.1)", height: 'calc(99.9vh - 55px)', padding: '10px 20px 0px' }}>
                        <div className="py-3 flex report_hdr_main">
                            <div className="report_hdr_ec" style={{ display: 'flex', gap: '7px', alignItems: 'center', whiteSpace: "nowrap" }}>
                                ...
                                <span className="report_hdr_txt_ec gap-2" style={{ color: 'var(--color1)', display: 'flex', fontWeight: 700, fontSize: '20px', alignItems: "center" }}> Top Customers
                                                            ...
                                                            <tr hover role="checkbox" tabIndex={-1} key={row.code} >
                                                                ...
                                                                {TopCustomerColumns.map((column, colIndex) => {
                                                                    ...
                                                                    const formattedValue = typeof value === 'string' && value.length > 0
                                                                        ...
                                                                        : value;
                                                                    return (
                                                                        <td key={column.id} align={column.align} style={colIndex === TopCustomerColumns.length - 1 ? { borderRadius: '0 10px 10px 0' } : {}}>
