        ...
        <>
            ...
            {isLoading ? <div className="loader-container ">
                ...
                <div style={{ backgroundColor: 'rgb(240, 240, 240)', height: 'calc(100vh - 120px)', padding: "0px 20px 0px", alignItems: "center", overflow: "auto" }} >
                    ...
                    <div>
                        <div className="firstrow flex" style={{
                            ...
                            <div style={{ display: 'flex' }}>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', padding: '0 20px' }}>
                                    <div className="gap-2 " onClick={toggleModal} style={{ display: "flex", alignItems: "center", cursor: "pointer", whiteSpace: 'nowrap' }}>
                                        ...
                                        <span className="gap-1" style={{ fontWeight: 800, fontSize: "22px", whiteSpace: 'nowrap', display: 'flex', alignItems: 'center' }}>{tableData?.net_amount ? tableData?.net_amount : 0}
                                            <FaCaretUp />
                                        </span>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="" style={{ display: 'flex', justifyContent: "space-between", paddingBottom: '5px' }}>
                                                ...
                                                <span style={{ fontWeight: 600, color: "red" }}> {isNaN(Number(tableData?.other_amount))
                                            ...
                                            <div className="" style={{ display: 'flex', justifyContent: "space-between", paddingBottom: '5px' }}>
                                                ...
                                                <span style={{ fontWeight: 600 }}>   {roundOff === "0.00"
                                                    ? roundOff
                                                    : roundOff < 0
                                                        ? `-${Math.abs(roundOff)}`
                                                        : `+${Math.abs(roundOff)}`}</span>
                                            </div>
                                            <div className="" style={{ display: 'flex', justifyContent: "space-between", paddingBottom: '5px' }}>
                                            ...
                                            <div className="" style={{ display: "flex", alignItems: "center", cursor: "pointer", justifyContent: "space-between", borderTop: '2px solid var(--COLOR_UI_PHARMACY)', paddingTop: '5px' }}>
                                                ...
                                                <label className="font-bold">Net Amount: </label>
                                                <span style={{ fontWeight: 800, fontSize: "22px", color: "var(--COLOR_UI_PHARMACY)" }}>{tableData?.net_amount ? tableData?.net_amount : 0}</span>
                                            </div>
                                        </div>
                                    </Modal>
                                </div>
